...
class Subuh extends StatelessWidget {
  const Subuh({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Card(
                ...
                shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(color: greenSubuhColor, width: 1.5)),
                child: Container(
                  height: 383,
                    ...
                    children: [
                      Card(
                        ...
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(20),
                            side:
                                BorderSide(color: greenSubuhColor, width: 1.5)),
                        child: Container(
                          height: 56,
                          width: double.infinity,
                          child: Row(
